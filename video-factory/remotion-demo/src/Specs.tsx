...
// ================= TIỀN KẸT TRONG BÊ TÔNG (BĐS 2026, cho người trẻ) — 42 CẢNH =================
// Cắt dày (~9s/cảnh) cho hợp YouTube · mỗi ý thoại = 1 khung · d snap khoảng lặng bds_long.mp3 (380s).
export const TIENKET: VideoSpec = {
  slug: 'TienKet',
  scenes: [
    {t: 'hook', d: 381, bar: 'navy', deco: '🏠', decoSide: 'l', ah: {pose: 'worried'},
      heading: ['Muốn mua nhà mà thấy ', {t: 'BẤT LỰC?', c: 'red'}], size: 74, capTop: 350,
      caption: ['Vài con số để bạn biết: bạn không hề đơn độc.']},
    {t: 'hook', d: 176, bar: 'navy', deco: '👂', decoSide: 'r',
      heading: ['Nghe hết nhé…'], size: 84, capTop: 300, caption: ['Bạn không hề vô dụng đâu.']},
    {t: 'number', d: 244, bar: 'red', heading: ['Giá nhà đang cao gấp'],
      value: 30, suffix: ' lần', numColor: 'red', sub: 'thu nhập 1 năm của cả gia đình'},
    {t: 'hook', d: 208, bar: 'red', deco: '🌏', decoSide: 'r',
      heading: ['Top 10 thế giới'], size: 82, capTop: 300, caption: ['về mức khó mua nhà nhất — gần gấp đôi thế giới.']},
    {t: 'number', d: 277, bar: 'red', heading: ['Dồn TOÀN BỘ thu nhập, mua nhà mất'],
      value: 30, suffix: ' năm', numColor: 'red', sub: 'mà vẫn chưa dám tiêu một đồng'},
    {t: 'number', d: 366, bar: 'red', deco: '😱', decoSide: 'r', heading: ['Trả góp 1/3 lương thì mất tới'],
      value: 80, suffix: ' năm', numColor: 'red', sub: 'Tám mươi năm — bạn nghe không nhầm đâu'},
    {t: 'versus', d: 386, bar: 'amber', heading: ['Khoảng cách quá lớn'],
      left: {pill: 'Lương ~8–9tr', sub: 'mỗi tháng', c: 'navy'}, right: {pill: 'Căn hộ ~4–5 tỷ', sub: 'mỗi căn', c: 'red'}},
    {t: 'hook', d: 174, bar: 'amber', deco: '🚫', decoSide: 'r',
      heading: ['Căn bình dân?'], size: 84, capTop: 300, caption: ['Gần như biến mất khỏi thị trường.']},
    {t: 'hook', d: 193, bar: 'teal', ah: {pose: 'think'},
      heading: ['Không phải bạn lười,'], size: 78, capTop: 300, caption: ['cũng không phải bạn kém cỏi.']},
    {t: 'hook', d: 285, bar: 'teal', ah: {pose: 'point'},
      heading: ['Đừng buông xuôi!'], size: 84, capTop: 320, caption: ['Anh Hai kể chuyện này để bạn TỈNH, không phải để nản.']},
    {t: 'hook', d: 263, bar: 'red', deco: '⚠️', decoSide: 'r',
      heading: ['Có 1 cái bẫy nguy hơn'], size: 74, capTop: 320, caption: ['cả việc chưa mua được nhà: cố mua bằng mọi giá rồi mắc kẹt.']},
    {t: 'hook', d: 82, bar: 'navy', center: true, heading: ['Nghe chuyện anh Tuấn 👇'], size: 76},
    {t: 'char', d: 293, bar: 'blue', ah: {pose: 'present', shirt: 'tuan'},
      heading: ['Anh Tuấn, ', {t: '35 tuổi', c: 'tuan'}], capTop: 260, caption: ['Dân văn phòng, thu nhập khá, tính cẩn thận.']},
    {t: 'char', d: 290, bar: 'blue', ah: {pose: 'present', shirt: 'tuan'},
      heading: ['Mua căn hộ ~2 tỷ'], capTop: 250, caption: ['Ngày ký hợp đồng, ai cũng mừng cho anh.'],
      items: [{text: '3 phần tiền túi', c: 'navy'}, {text: '7 phần tiền vay', c: 'red'}], stackTop: 420},
    {t: 'char', d: 260, bar: 'blue', ah: {pose: 'present', shirt: 'tuan'},
      heading: ['Anh tin mình vừa thắng lớn'], size: 68, capTop: 300, caption: ['Nhưng anh sắp vỡ mộng… 4 lần.']},
    {t: 'hook', d: 295, bar: 'teal', deco: '📈', decoSide: 'r', ah: {pose: 'cool'},
      heading: [{t: 'Niềm tin #1', c: 'teal'}], size: 86, capTop: 320, caption: ['“Bất động sản chỉ có lên” — nghe rất hợp lý.']},
    {t: 'hook', d: 181, bar: 'teal', ah: {pose: 'cool'},
      heading: ['Ôm vài năm là lời?'], size: 80, capTop: 300, caption: ['Cả một thế hệ tin như vậy.']},
    {t: 'hook', d: 205, bar: 'red', deco: '📈', decoSide: 'r',
      heading: ['Nhưng lãi suất ', {t: 'thả nổi', c: 'red'}], size: 74, capTop: 320, caption: ['Nhích lên 12, rồi mười mấy phần trăm một năm.']},
    {t: 'versus', d: 287, bar: 'red', heading: ['Lãi suất ', {t: 'đảo chiều', c: 'red'}],
      left: {pill: 'Gửi 6–7%', sub: 'để dành', c: 'teal'}, right: {pill: 'Vay 12–15%', sub: 'ôm nhà', c: 'red'}},
    {t: 'hook', d: 218, bar: 'red', deco: '💸', decoSide: 'r',
      heading: ['Đắt gần ', {t: 'GẤP ĐÔI', c: 'red'}], size: 82, capTop: 320, caption: ['Mỗi tháng, lãi vay ăn thẳng vào thu nhập.']},
    {t: 'rule', d: 110, bar: 'teal', n: 1, title: 'Dòng tiền > giá trên giấy', color: 'teal', heading: ['Bài học #1']},
    {t: 'hook', d: 232, bar: 'teal', ah: {pose: 'think'},
      heading: ['Nó giữ bạn,'], size: 82, capTop: 300, caption: ['chứ không phải bạn giữ nó — nếu tháng nào cũng phải nuôi.']},
    {t: 'hook', d: 318, bar: 'teal', deco: '🔑', decoSide: 'r',
      heading: [{t: 'Niềm tin #2', c: 'teal'}], size: 86, capTop: 320, caption: ['“Trả góp thì coi như tiền thuê nhà thôi mà.”']},
    {t: 'hook', d: 271, bar: 'red', deco: '🏚️', decoSide: 'r',
      heading: ['Rao bán cả năm…'], size: 80, capTop: 320, caption: ['Một tháng, hai tháng, nửa năm — chẳng mấy ai hỏi.']},
    {t: 'number', d: 264, bar: 'red', heading: ['Tồn kho BĐS cả nước'],
      value: 500, suffix: ' nghìn tỷ', numSize: 88, numColor: 'red', sub: 'căn hộ, đất nền nằm im chờ người mua'},
    {t: 'rule', d: 289, bar: 'amber', n: 2, title: 'Đòn bẩy = con dao 2 lưỡi', color: 'amber',
      heading: ['Bài học #2'], caption: ['Tính kịch bản xấu nhất trước khi ký.']},
    {t: 'hook', d: 326, bar: 'amber', ah: {pose: 'think'},
      heading: ['Còn gồng nổi không?'], size: 76, capTop: 320, caption: ['Nếu lãi lên 15%, cả năm không bán được — trả lời được rồi hãy đặt bút.']},
    {t: 'hook', d: 224, bar: 'gray', ah: {pose: 'present', shirt: 'tuan'},
      heading: [{t: 'Niềm tin #3', c: 'gray'}], size: 86, capTop: 320, caption: ['“Dự án lớn thì cứ yên tâm.”']},
    {t: 'hook', d: 111, bar: 'red', deco: '🏗️', decoSide: 'r',
      heading: ['Ngày bàn giao cứ ', {t: 'LÙI', c: 'red'}], size: 74},
    {t: 'list', d: 283, bar: 'red', heading: ['Chủ đầu tư cũng ', {t: 'kẹt vốn', c: 'red'}], size: 66,
      items: [{text: 'Ôm quá nhiều dự án', c: 'red'}, {text: 'Vay nợ chồng chất', c: 'red'}, {text: 'Dòng tiền âm', c: 'red'}],
      stackTop: 420, caption: ['Người bán nhà cho anh cũng đang khát tiền.']},
    {t: 'hook', d: 260, bar: 'red', deco: '🚧', decoSide: 'r',
      heading: ['3 dấu hiệu dự án nguy'], size: 74, capTop: 320, caption: ['① Tiến độ chậm dần — hứa hoài, công trường im lìm.']},
    {t: 'list', d: 354, bar: 'red', heading: ['Dấu hiệu 2 & 3'], size: 76,
      items: [{text: '② Bán tháo gom tiền mặt', c: 'red'}, {text: '③ Ôm quá nhiều dự án', c: 'red'}],
      stackTop: 420, caption: ['Ba dấu hiệu cùng bật lên = hết sức thận trọng.']},
    {t: 'rule', d: 351, bar: 'navy', n: 3, title: 'Bạn mua một LỜI HỨA bàn giao', color: 'navy',
      heading: ['Bài học #3'], caption: ['Lời hứa chỉ vững khi chủ đầu tư còn dòng tiền.']},
    {t: 'number', d: 333, bar: 'amber', deco: '🎣', decoSide: 'r', heading: ['Có người mời góp vốn, cam kết lời'],
      value: 18, suffix: '%/năm', numColor: 'gold', sub: 'Đang bí, mắt anh sáng lên…'},
    {t: 'hook', d: 192, bar: 'amber', ah: {pose: 'think'},
      heading: ['Khựng lại. Tự hỏi:'], size: 78, capTop: 300, caption: ['Ngân hàng cho vay còn mười mấy phần trăm…']},
    {t: 'hook', d: 341, bar: 'red', deco: '🔄', decoSide: 'r',
      heading: ['Lấy ĐÂU ra 18%?'], size: 82, capTop: 320, caption: ['Thường là lấy tiền người vào sau, trả cho người vào trước.']},
    {t: 'rule', d: 361, bar: 'red', n: 4, title: 'Lợi nhuận cao = rủi ro cao', color: 'red',
      heading: ['Bài học #4'], caption: ['Lời cao bất thường thường là bẫy. Không có bữa trưa miễn phí.']},
    {t: 'hook', d: 297, bar: 'teal', ah: {pose: 'point'},
      heading: ['Quay lại với BẠN'], size: 82, capTop: 320, caption: ['Người trẻ đang muốn mua nhà — nhớ 4 điều để xuống tiền cho tỉnh.']},
    {t: 'list', d: 275, bar: 'teal', heading: ['4 điều ', {t: 'giắt túi', c: 'teal'}], size: 78,
      items: [{text: '① Dòng tiền > giá giấy', c: 'teal'}, {text: '② Đòn bẩy = dao 2 lưỡi', c: 'amber'}, {text: '③ Đọc dấu hiệu dự án', c: 'navy'}, {text: '④ Lời cao = rủi ro cao', c: 'red'}],
      stackTop: 360, gap: 18},
    {t: 'hook', d: 386, bar: 'teal', ah: {pose: 'point'},
      heading: ['Chưa mua được ≠ ', {t: 'THẤT BẠI', c: 'red'}], size: 68, capTop: 340, caption: ['Cả một thế hệ đang cùng cảnh. Đừng để tiền nằm chết, gồng lãi mỗi tháng.']},
    {t: 'hook', d: 429, bar: 'navy', ah: {pose: 'cool'},
      heading: ['Căn nhà đẹp nhất là căn bạn mua mà vẫn ', {t: 'NGỦ NGON', c: 'teal'}], size: 60, capTop: 360, caption: ['Tiền bê tông đẹp — nhưng lúc ngặt không mua nổi tô phở.']},
    {t: 'hook', d: 330, bar: 'navy', ah: {pose: 'point'}, bubble: {text: 'Giữ ví cho chặt!', x: 1120, y: 300},
      heading: ['Bạn team nào?'], size: 84, capTop: 320, caption: ['Cố mua cho bằng được — hay giữ tiền chờ đúng thời điểm?']},
  ],
};
