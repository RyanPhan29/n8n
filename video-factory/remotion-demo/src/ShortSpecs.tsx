import {ShortSpec, VBlock} from './Short';

// ===================== COVER / THUMBNAIL (MẪU KHÓA) =====================
// Cảnh MỞ ĐẦU chuẩn — frame đầu dùng luôn làm ẢNH BÌA (thumbnail).
// Công thức: dòng1 (đen) + KEYWORD (đỏ) + dòng3 (đen) + pill HOOK (navy) + Anh Hai cảm xúc.
// LƯU Ý: mỗi dòng head ≤ ~10 ký tự để chữ TO mà không tràn viền. Hook ≤ ~26 ký tự.
// Dùng: scenes[0] = cover('ĐÁNH THUẾ', 'NHÀ THỨ 2', 'CÔNG BẰNG?', 'Chặn đầu cơ hay TẬN THU?', 'shock')
// Giữ cover ~1.2-1.5s đầu (d mặc định 40 frame) rồi vào nội dung. Pose gợi ý: shock / sly / greedy / worried.
export const cover = (
  line1: string, keyword: string, line3: string, hook: string,
  pose: string = 'shock', d: number = 40, size: number = 122,
): VBlock => ({
  d, bar: 'red', pose, ahCorner: 'right', ahH: 640,
  head: [line1 + '\n', {t: keyword, c: 'red'}, '\n' + line3], size, htop: 230,
  label: [hook], labelTop: 760, labelC: 'navy',
});
// Ví dụ mẫu (test): ShortCover
export const SHORT_COVER: ShortSpec = { slug: 'ShortCover', scenes: [
  cover('ĐÁNH THUẾ', 'NHÀ THỨ 2', 'CÔNG BẰNG?', 'Chặn đầu cơ hay TẬN THU?', 'shock'),
]};
...
export const SHORT_DT1: ShortSpec = { slug: 'ShortDT1', scenes: [
  ...
  {d: 53, bar: 'navy', pose: 'present', ahCorner: 'right', ahH: 600,
    ...
    icon: '⚖️  🏞️', iconTop: 540, iconSize: 170},
  {d: 164, bar: 'navy', pose: 'think', ahH: 620,
    source: {name: 'VietnamNet', date: '4/8/2026'},
    evidence: {headline: ['Cha ký hợp đồng tặng con\n~1,5 héc-ta đất'],
      quote: ['“Sau đó khởi kiện xin hủy hợp đồng”'], src: 'VietnamNet · Pháp luật'}, evidenceTop: 300},
  {d: 201, bar: 'blue', pose: 'point', ahCorner: 'left', ahH: 600,
    head: ['Tòa ', {t: 'CHẤP NHẬN HỦY', c: 'blue'}], size: 62, htop: 240,
    icon: '📜  ✍️', iconTop: 540, iconSize: 160,
    label: ['Chưa sang tên → chưa phát sinh hiệu lực'], labelTop: 850, labelC: 'blue'},
  {d: 184, bar: 'amber', pose: 'think', ahCorner: 'left', ahH: 560,
    head: ['Trong nhà ', {t: 'CHIA PHE', c: 'amber'}], size: 66, htop: 230,
    cards: [
      {header: 'VỢ & VÀI CON', icon: '✅', label: 'Đồng ý hủy', c: 'teal'},
      {header: 'CÁC CON KHÁC', icon: '🙅', label: 'Phản đối', c: 'red'}],
    cardsTop: 480},
  {d: 158, bar: 'blue', pose: 'aha', ahCorner: 'right', ahH: 600,
    head: ['👁 Đọc vị ', {t: 'PHÁP LÝ', c: 'blue'}], size: 62, htop: 250,
    icon: '⚖️', iconTop: 540, iconSize: 170,
    label: ['Đất chưa sang tên, người tặng còn quyền rút'], labelTop: 850, labelC: 'blue'},
  {d: 120, bar: 'teal', pose: 'think', ahCorner: 'left', ahH: 600,
    head: ['Còn ', {t: 'ĐẠO LÝ', c: 'teal'}, '?'], size: 70, htop: 250,
    icon: '❤️  🤝', iconTop: 540, iconSize: 160,
    label: ['Lời hứa cha mẹ với con — mỗi nhà một cách nghĩ'], labelTop: 850, labelC: 'teal'},
  {d: 190, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 680,
    head: ['Bạn bênh ai?'], size: 76, htop: 250,
    q: ['Cha được quyền đổi ý, hay ', {t: 'con giữ chữ tín?', c: 'gold'}]},
]};
...
export const SHORT_DT2: ShortSpec = { slug: 'ShortDT2', scenes: [
  ...
  {d: 104, bar: 'blue', pose: 'present', ahCorner: 'right', ahH: 600,
    ...
    icon: '🏦  📈', iconTop: 540, iconSize: 170},
  {d: 214, bar: 'blue', pose: 'think', ahH: 600,
    source: {name: 'Khảo sát biểu LS', date: '8/2026'},
    head: ['Ngân hàng lớn niêm yết\nkỳ hạn dài'], size: 58, htop: 250,
    icon: '📋', iconTop: 560, iconSize: 150,
    label: ['Theo khảo sát các biểu lãi suất mới nhất'], labelTop: 850, labelC: 'gray'},
  {d: 97, bar: 'blue', pose: 'point', ahCorner: 'right', ahH: 600,
    head: ['Kỳ hạn dài quanh'], size: 60, htop: 230,
    value: 7, suffix: ',2–7,4%', numColor: 'blue', numTop: 520, numSize: 150,
    label: ['một năm'], labelTop: 820, labelC: 'blue'},
  {d: 136, bar: 'teal', pose: 'aha', ahCorner: 'left', ahH: 600,
    head: ['Có nhà băng đẩy lên'], size: 60, htop: 230,
    value: 7, suffix: ',8%', numColor: 'teal', numTop: 520, numSize: 160,
    label: ['/năm'], labelTop: 820, labelC: 'teal'},
  {d: 103, bar: 'navy', pose: 'present', ahCorner: 'right', ahH: 600,
    head: ['Và khoảng'], size: 62, htop: 230,
    value: 7, suffix: ' NH', numColor: 'navy', numTop: 520, numSize: 160,
    label: ['niêm yết từ 7% trở lên'], labelTop: 820, labelC: 'navy'},
  {d: 182, bar: 'amber', pose: 'think', ahCorner: 'left', ahH: 600,
    head: ['👁 Tín hiệu gì?'], size: 64, htop: 250,
    icon: '🏠  💳', iconTop: 540, iconSize: 160,
    label: ['NH cần hút vốn → lãi vay mua nhà dễ tăng theo'], labelTop: 850, labelC: 'amber'},
  {d: 157, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 680,
    head: ['Bạn chọn hướng nào?'], size: 66, htop: 250,
    q: ['Khóa gửi dài ăn chắc, hay ', {t: 'giữ tiền linh hoạt?', c: 'gold'}]},
]};
...
export const SHORT_DT3: ShortSpec = { slug: 'ShortDT3', scenes: [
  ...
  {d: 200, bar: 'gold', pose: 'present', ahCorner: 'right', ahH: 580,
    ...
    label: ['mỗi lượng'], labelTop: 800, labelC: 'gold'},
  {d: 207, bar: 'red', pose: 'shock', ahCorner: 'left', ahH: 580,
    head: ['Cao hơn giá thế giới'], size: 60, htop: 230,
    value: 12, suffix: ' tr/lượng', numColor: 'red', numTop: 500, numSize: 170,
    label: ['người mua đang trả thêm khoản lớn'], labelTop: 800, labelC: 'red'},
  {d: 216, bar: 'navy', pose: 'think', ahH: 600,
    source: {name: 'Giá vàng', date: '4/8/2026'},
    head: ['Thế giới quanh'], size: 58, htop: 230,
    value: 4030, suffix: ' USD/oz', numColor: 'navy', numTop: 520, numSize: 130,
    label: ['đã rất cao — trong nước còn cao hơn'], labelTop: 820, labelC: 'navy'},
  {d: 127, bar: 'blue', pose: 'aha', ahCorner: 'right', ahH: 600,
    head: ['👁 Nghĩa là gì?'], size: 64, htop: 250,
    icon: '⚠️  📉', iconTop: 540, iconSize: 160,
    label: ['Chênh thu hẹp → mua đỉnh chịu rủi ro trước'], labelTop: 850, labelC: 'blue'},
  {d: 174, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 680,
    head: ['Còn nên mua lúc này?'], size: 64, htop: 250,
    q: ['Chênh 12 triệu/lượng, ', {t: 'bạn xuống tiền không?', c: 'gold'}]},
]};
...
export const SHORT_DT4: ShortSpec = { slug: 'ShortDT4', scenes: [
  ...
  {d: 81, bar: 'red', pose: 'shock', ahCorner: 'right', ahH: 600,
    ...
    icon: '🏢  🧾', iconTop: 540, iconSize: 170},
  {d: 236, bar: 'navy', pose: 'present', ahH: 600,
    source: {name: 'Cơ quan thuế', date: '2026'},
    head: ['Thanh, kiểm tra thuế'], size: 60, htop: 230,
    value: 30, suffix: ' DN', numColor: 'navy', numTop: 500, numSize: 170,
    label: ['doanh nghiệp bất động sản'], labelTop: 800, labelC: 'navy'},
  {d: 168, bar: 'red', pose: 'shock', ahCorner: 'left', ahH: 580,
    head: ['Kiến nghị xử lý thuế'], size: 58, htop: 230,
    value: 565, suffix: ',6 tỷ', numColor: 'red', numTop: 500, numSize: 150,
    label: ['tổng số tiền'], labelTop: 800, labelC: 'red'},
  {d: 151, bar: 'amber', pose: 'think', ahCorner: 'right', ahH: 580,
    head: ['Bình quân mỗi DN'], size: 60, htop: 230,
    value: 21, suffix: ',7 tỷ', numColor: 'amber', numTop: 500, numSize: 160,
    label: ['cao gấp nhiều lần DN ngành khác'], labelTop: 800, labelC: 'amber'},
  {d: 130, bar: 'blue', pose: 'present', ahCorner: 'left', ahH: 600,
    head: ['Năm sau ', {t: 'KIỂM THÊM', c: 'blue'}], size: 62, htop: 250,
    icon: '📅  🔎', iconTop: 540, iconSize: 160,
    label: ['hàng chục doanh nghiệp nữa'], labelTop: 850, labelC: 'blue'},
  {d: 143, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
    head: ['👁 Ai gánh cuối cùng?'], size: 62, htop: 250,
    icon: '➡️  🏠', iconTop: 540, iconSize: 160,
    label: ['Chi phí thường cộng vào giá bán → người mua'], labelTop: 850, labelC: 'navy'},
  {d: 105, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 680,
    head: ['Siết thuế BĐS:'], size: 68, htop: 250,
    q: ['Giá nhà hạ nhiệt, hay ', {t: 'đẩy lên đầu người mua?', c: 'gold'}]},
]};

// DT5 — BĐS quý 2 phân hóa: kẻ lãi mấy chục lần, người lỗ nặng
export const SHORT_DT5: ShortSpec = { slug: 'ShortDT5', scenes: [
  cover('CÙNG BĐS', 'KẺ LÃI', 'NGƯỜI LỖ', 'Phân hóa dữ dội quý 2', 'shock', 114),
  {d: 197, bar: 'teal', pose: 'present', ahCorner: 'right', ahH: 580,
    source: {name: 'BCTC quý 2', date: '2026'},
    head: ['Có DN lợi nhuận tăng'], size: 58, htop: 230,
    value: 24, suffix: ' lần', numColor: 'teal', numTop: 500, numSize: 170,
    label: ['bức tranh phân hóa rất mạnh'], labelTop: 800, labelC: 'teal'},
  {d: 98, bar: 'red', pose: 'worried', ahCorner: 'left', ahH: 600,
    head: ['DN khác ', {t: 'THUA LỖ', c: 'red'}], size: 66, htop: 250,
    icon: '📉  🏚️', iconTop: 540, iconSize: 170,
    label: ['lỗ kéo dài'], labelTop: 850, labelC: 'red'},
  {d: 191, bar: 'amber', pose: 'think', ahCorner: 'right', ahH: 600,
    head: ['Cùng ngành — ', {t: 'TRÁI NGƯỢC', c: 'amber'}], size: 58, htop: 250,
    icon: '⚖️', iconTop: 540, iconSize: 170,
    label: ['cùng thị trường mà số phận khác nhau'], labelTop: 850, labelC: 'amber'},
  {d: 139, bar: 'red', pose: 'shock', ahCorner: 'left', ahH: 600,
    head: ['Rủi ro ', {t: 'LAN RỘNG', c: 'red'}], size: 64, htop: 250,
    icon: '🏦  ⚠️', iconTop: 540, iconSize: 160,
    label: ['có thể lan sang ngân hàng vừa & nhỏ'], labelTop: 850, labelC: 'red'},
  {d: 102, bar: 'blue', pose: 'point', ahCorner: 'right', ahH: 600,
    head: ['👁 Bài học'], size: 66, htop: 250,
    icon: '🎯', iconTop: 540, iconSize: 160,
    label: ['BĐS không có nghĩa chỗ nào cũng ăn chắc'], labelTop: 850, labelC: 'blue'},
  {d: 163, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 680,
    head: ['Nửa cuối năm?'], size: 72, htop: 250,
...
// ===== 25 spec bộ 30 mới (N02-N30) — sub-agent viết, timed Whisper =====
export const SHORT_N02: ShortSpec = {
  slug: 'ShortN02',
  scenes: [
    cover('THUÊ NHÀ', 'HAY MUA', 'TUỔI 30?', 'Ai khôn hơn?', 'think', 92),
    {d: 31, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['Thuê thì nhẹ đầu'], size: 78,
      label: ['Trả phòng rồi thôi'], labelTop: 560, labelC: 'teal'},
    {d: 67, bar: 'teal', pose: 'cash', ahCorner: 'left', ahH: 600,
      head: ['Dư đồng nào ', {t: 'để dành', c: 'teal'}], size: 72,
      icon: '💰', iconTop: 540, iconSize: 170,
      label: ['Nhẹ đầu, linh hoạt'], labelTop: 840, labelC: 'teal'},
    {d: 95, bar: 'amber', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Ở nhà người ta'], size: 72,
      icon: '📦', iconTop: 540, iconSize: 170,
      label: ['Chủ đòi là phải dọn'], labelTop: 840, labelC: 'amber'},
    {d: 140, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Mua trả góp gánh nợ'], size: 62,
      value: 50, suffix: '%', staticNum: true, numColor: 'red', numTop: 520, numSize: 175,
      label: ['Lãi bằng nửa căn nhà'], labelTop: 830, labelC: 'red'},
    {d: 87, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Đổi lại có ', {t: 'cái nền', c: 'teal'}], size: 74,
      icon: '🏠', iconTop: 540, iconSize: 180,
      label: ['Chỗ chui ra của mình'], labelTop: 850, labelC: 'teal'},
    {d: 77, bar: 'navy', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Mỗi bên một gia tài'], size: 62,
      cards: [
        {header: 'ĐỘI THUÊ', icon: '🕊️', label: 'Giữ tự do', c: 'teal'},
        {header: 'ĐỘI MUA', icon: '🏠', label: 'Giữ cái nền', c: 'blue'},
      ], cardsTop: 450},
    {d: 220, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Chẳng ai sai đâu'], size: 76,
      q: ['Bạn thuê cho nhẹ hay ', {t: 'mua cho yên?', c: 'gold'}]},
  ],
};

export const SHORT_N03: ShortSpec = {
  slug: 'ShortN03',
  scenes: [
    cover('TÍN DỤNG', 'VS GHI NỢ', 'AI RÚT VÍ?', 'Cái nào cắn ngầm?', 'sly', 44),
    {d: 59, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 600,
      head: ['Hai thẻ nhìn ', {t: 'y hệt', c: 'navy'}], size: 74,
      label: ['Một êm, một cắn ngầm'], labelTop: 560, labelC: 'navy'},
    {d: 43, bar: 'teal', pose: 'cool', ahCorner: 'left', ahH: 600,
      head: ['Ghi nợ là tiền mình'], size: 68,
      label: ['Hết là dừng'], labelTop: 560, labelC: 'teal'},
    {d: 72, bar: 'blue', pose: 'greedy', ahCorner: 'right', ahH: 600,
      head: ['Tín dụng xài ', {t: 'tiền bank', c: 'blue'}], size: 62,
      label: ['Xài trước, sướng tay'], labelTop: 560, labelC: 'blue'},
    {d: 80, bar: 'red', pose: 'warning', ahCorner: 'left', ahH: 600,
      head: ['Trả trễ một ngày'], size: 72,
      icon: '⏰', iconTop: 540, iconSize: 170,
      label: ['Lãi nhảy vào ngay'], labelTop: 840, labelC: 'red'},
    {d: 118, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Phí chồng phí'], size: 76,
      icon: '💸', iconTop: 540, iconSize: 180,
      label: ['Niên phí · rút tiền · trễ hạn'], labelTop: 850, labelC: 'red'},
    {d: 117, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Rút ví ', {t: 'trong im lặng', c: 'red'}], size: 66,
      icon: '🤫', iconTop: 540, iconSize: 180,
      label: ['Không la làng một tiếng'], labelTop: 850, labelC: 'red'},
    {d: 137, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Mỗi thẻ dạy một kiểu'], size: 60,
      cards: [
        {header: 'GHI NỢ', icon: '✅', label: 'Sống trong khả năng', c: 'teal'},
        {header: 'TÍN DỤNG', icon: '⚠️', label: 'Thử lòng kỷ luật', c: 'red'},
      ], cardsTop: 450},
    {d: 126, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Ai lơ là là dính'], size: 76,
      q: ['Bạn đang xài ', {t: 'thẻ nào?', c: 'gold'}]},
  ],
};

export const SHORT_N04: ShortSpec = {
  slug: 'ShortN04',
  scenes: [
    cover('VÀNG NHẪN', 'VS SJC', 'AI LỜI HƠN?', 'Cùng vàng, giá lệch', 'greedy', 87),
    {d: 89, bar: 'gold', pose: 'think', ahCorner: 'right', ahH: 600,
      head: ['Cùng là vàng'], size: 80,
      label: ['Mà giá lệch cả khúc'], labelTop: 560, labelC: 'gold'},
    {d: 113, bar: 'blue', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['SJC là ', {t: 'hàng quốc gia', c: 'blue'}], size: 60,
      icon: '🏅', iconTop: 540, iconSize: 170,
      label: ['Tiếng tăm, dễ bán'], labelTop: 840, labelC: 'blue'},
    {d: 43, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Nhưng bị đội giá'], size: 74,
      label: ['Mua là mất ngay'], labelTop: 560, labelC: 'red'},
    {d: 125, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['SJC chênh thế giới'], size: 66,
      value: 12, suffix: ' triệu', staticNum: true, numColor: 'red', numTop: 540, numSize: 180,
      label: ['Chưa mua đã lỗ một khúc'], labelTop: 850, labelC: 'red'},
    {d: 81, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['Nhẫn trơn bám giá sát'], size: 60,
      value: 142, suffix: ' triệu', staticNum: true, numColor: 'teal', numTop: 540, numSize: 160,
      label: ['Chênh ít hơn SJC'], labelTop: 850, labelC: 'teal'},
    {d: 89, bar: 'navy', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['Mỗi loại hợp một người'], size: 58,
      cards: [
        {header: 'ĐỘI NHẪN', icon: '💍', label: 'Tích trữ lâu dài', c: 'teal'},
        {header: 'ĐỘI SJC', icon: '🥇', label: 'Thanh khoản nhanh', c: 'blue'},
      ], cardsTop: 450},
    {d: 214, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Khác nhau chỗ đó'], size: 76,
      q: ['Bạn chọn ', {t: 'nhẫn hay SJC?', c: 'gold'}]},
  ],
};

export const SHORT_N05: ShortSpec = {
  slug: 'ShortN05',
  scenes: [
    cover('TRẢ GÓP', '0%?', 'CÓ BẪY!', 'Chênh bao nhiêu tiền?', 'sly', 45),
    {d: 38, bar: 'blue', pose: 'present', ahCorner: 'right', ahH: 600,
      head: ['Cái tivi giá'], size: 72,
      value: 10, suffix: ' triệu', staticNum: true, numColor: 'blue', numTop: 540, numSize: 180,
      label: ['Nghe giá cũng mềm'], labelTop: 850, labelC: 'blue'},
    {d: 31, bar: 'amber', pose: 'greedy', ahCorner: 'left', ahH: 600,
      head: ['Trả góp ', {t: '0%', c: 'teal'}], size: 82,
      label: ['Nghe mê chưa'], labelTop: 560, labelC: 'amber'},
    {d: 26, bar: 'red', pose: 'warning', ahCorner: 'right', ahH: 600,
      head: ['Mà khoan...'], size: 84,
      label: ['Chữ đó có bẫy'], labelTop: 560, labelC: 'red'},
    {d: 52, bar: 'red', pose: 'sly', ahCorner: 'left', ahH: 600,
      head: ['Không ai cho không'], size: 66,
      icon: '🪝', iconTop: 540, iconSize: 170,
      label: ['Bẫy nằm chỗ khác'], labelTop: 840, labelC: 'red'},
    {d: 150, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Phí chuyển đổi trả góp'], size: 60,
      icon: '🪤', iconTop: 540, iconSize: 175,
      label: ['Tầm 2,5–6% khoản vay'], labelTop: 850, labelC: 'red'},
    {d: 133, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Ép thêm bảo hiểm vay'], size: 60,
      icon: '🧾', iconTop: 540, iconSize: 175,
      label: ['3–6% nữa · trả dư cả mớ'], labelTop: 850, labelC: 'red'},
    {d: 172, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Mỗi bên mua một thứ'], size: 60,
      cards: [
        {header: 'TRẢ GÓP', icon: '🛒', label: 'Mua sự tiện', c: 'amber'},
        {header: 'ĐỂ DÀNH', icon: '🐷', label: 'Mua sự yên', c: 'teal'},
      ], cardsTop: 450},
    {d: 159, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Tiện hay yên?'], size: 78,
      q: ['Bạn trả góp hay ', {t: 'đợi đủ tiền?', c: 'gold'}]},
  ],
};

export const SHORT_N06: ShortSpec = {
  slug: 'ShortN06',
  scenes: [
    cover('CÓ KỲ HẠN', 'VS KHÔNG', 'MẤT LÃI?', 'Để nhầm mất bao nhiêu?', 'shock', 83),
    {d: 30, bar: 'navy', pose: 'present', ahCorner: 'right', ahH: 600,
      head: ['Cùng nằm trong bank'], size: 60,
      value: 100, suffix: ' triệu', staticNum: true, numColor: 'navy', numTop: 540, numSize: 175,
      label: ['Cùng một số tiền'], labelTop: 850, labelC: 'navy'},
    {d: 31, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['Một ', {t: 'sinh lời', c: 'teal'}, ', một ', {t: 'nằm chết', c: 'red'}], size: 58,
      label: ['Hai số phận'], labelTop: 560, labelC: 'navy'},
    {d: 134, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['Có kỳ hạn 12 tháng'], size: 64,
      icon: '📈', iconTop: 540, iconSize: 175,
      label: ['Lãi tầm 4,7–6%/năm'], labelTop: 850, labelC: 'teal'},
    {d: 194, bar: 'red', pose: 'worried', ahCorner: 'left', ahH: 600,
      head: ['Không kỳ hạn'], size: 76,
      icon: '💤', iconTop: 540, iconSize: 180,
      label: ['Chỉ 0,1–0,5% · gần như 0'], labelTop: 850, labelC: 'red'},
    {d: 107, bar: 'amber', pose: 'facepalm', ahCorner: 'right', ahH: 600,
      head: ['Để cả trăm triệu nằm im'], size: 56,
      icon: '⏳', iconTop: 540, iconSize: 175,
      label: ['Mất lãi mà tưởng an toàn'], labelTop: 850, labelC: 'amber'},
    {d: 87, bar: 'navy', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['Cùng tiền, hai số phận'], size: 58,
      cards: [
        {header: 'CÓ KỲ HẠN', icon: '📈', label: 'Tiền sinh lời', c: 'teal'},
        {header: 'KHÔNG KỲ HẠN', icon: '💤', label: 'Tiền nằm chết', c: 'gray', dim: true},
      ], cardsTop: 450},
    {d: 99, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Đừng để nhầm'], size: 78,
      q: ['Tiền bạn đang ', {t: 'nằm ở đâu?', c: 'gold'}]},
  ],
};

export const SHORT_N07: ShortSpec = {
  slug: 'ShortN07',
  scenes: [
    cover('BẢO HIỂM', 'VS ĐẦU TƯ', 'TIỀN ĐI ĐÂU?', '3 triệu/tháng · 20 năm', 'think', 149),
    {d: 118, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['Bảo hiểm cho ', {t: 'sự an tâm', c: 'teal'}], size: 60,
      icon: '🛡️', iconTop: 540, iconSize: 175,
      label: ['Có chuyện là được chi trả'], labelTop: 850, labelC: 'teal'},
    {d: 155, bar: 'amber', pose: 'shrug', ahCorner: 'left', ahH: 600,
      head: ['Nhưng tích lũy chậm'], size: 66,
      icon: '🐢', iconTop: 540, iconSize: 180,
      label: ['Phần sinh lời rề rà'], labelTop: 850, labelC: 'amber'},
    {d: 106, bar: 'blue', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Tự đầu tư · lãi kép'], size: 62,
      value: 7, suffix: '%/năm', staticNum: true, numColor: 'blue', numTop: 540, numSize: 170,
      label: ['Đều đặn mỗi tháng'], labelTop: 850, labelC: 'blue'},
    {d: 88, bar: 'navy', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Gốc bỏ ra 20 năm'], size: 64,
      value: 720, suffix: ' triệu', staticNum: true, numColor: 'navy', numTop: 540, numSize: 170,
      label: ['3 triệu mỗi tháng'], labelTop: 850, labelC: 'navy'},
    {d: 47, bar: 'teal', pose: 'aha', ahCorner: 'right', ahH: 600,
      head: ['Gom lại thành ', {t: '1,5 tỷ', c: 'gold'}], size: 66,
      label: ['Lãi kép cuộn lên'], labelTop: 560, labelC: 'teal'},
    {d: 46, bar: 'navy', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Hai kiểu dùng tiền'], size: 62,
      cards: [
        {header: 'BẢO HIỂM', icon: '🛡️', label: 'Bán sự bảo vệ', c: 'teal'},
        {header: 'ĐẦU TƯ', icon: '📈', label: 'Nuôi tăng trưởng', c: 'blue'},
      ], cardsTop: 450},
    {d: 94, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Khác cả gia tài'], size: 76,
      q: ['Bạn tin bảo hiểm hay ', {t: 'tự đầu tư?', c: 'gold'}]},
  ],
};

export const SHORT_N08: ShortSpec = {
  slug: 'ShortN08',
  scenes: [
    cover('XE ĐIỆN', 'VS XĂNG', '5 NĂM SAU', 'Ai tốn hơn?', 'think', 114),
    {d: 37, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 600,
      head: ['Giá mua na ná'], size: 76,
      label: ['Ngang nhau lúc đầu'], labelTop: 560, labelC: 'navy'},
    {d: 44, bar: 'navy', pose: 'worried', ahCorner: 'left', ahH: 600,
      head: ['Năm năm sau...'], size: 78,
      label: ['Ví ai mỏng hơn?'], labelTop: 560, labelC: 'navy'},
    {d: 130, bar: 'amber', pose: 'shrug', ahCorner: 'right', ahH: 600,
      head: ['Xe xăng quen tay'], size: 68,
      icon: '⛽', iconTop: 540, iconSize: 180,
      label: ['Xăng, nhớt, bảo dưỡng đều'], labelTop: 850, labelC: 'amber'},
    {d: 90, bar: 'teal', pose: 'cool', ahCorner: 'left', ahH: 600,
      head: ['Xe điện sạc rẻ hơn'], size: 66,
      icon: '🔋', iconTop: 540, iconSize: 180,
      label: ['Ít đồ phải thay'], labelTop: 850, labelC: 'teal'},
    {d: 182, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Nhưng pin là ẩn số'], size: 66,
      icon: '🪫', iconTop: 540, iconSize: 180,
      label: ['Chai pin, thay là xót ví'], labelTop: 850, labelC: 'red'},
    {d: 100, bar: 'navy', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['Mỗi bên một kiểu tốn'], size: 60,
      cards: [
        {header: 'ĐỘI ĐIỆN', icon: '🔌', label: 'Rẻ đường dài', c: 'teal'},
        {header: 'ĐỘI XĂNG', icon: '⛽', label: 'Chắc ăn đi xa', c: 'amber'},
      ], cardsTop: 450},
    {d: 95, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Mỗi bên một lợi'], size: 78,
      q: ['Bạn đội điện hay ', {t: 'đội xăng?', c: 'gold'}]},
  ],
};
export const SHORT_N10: ShortSpec = {
  slug: 'ShortN10',
  scenes: [
    cover('CASHBACK', '2%', 'CÓ BẪY?', 'Hoàn tiền = móc ví?', 'sly', 140),
    {d: 131, bar: 'teal', pose: 'sly', ahCorner: 'left', ahH: 600,
      head: ['Thẻ hoàn tiền ', {t: '2%', c: 'teal'}, ' 💳'], size: 74,
      label: ['Nghe như được cho tiền'], labelTop: 560, labelC: 'teal'},
    {d: 123, bar: 'red', pose: 'greedy', ahCorner: 'right', ahH: 600,
      head: ['Ngân hàng tính hết rồi'], size: 58,
      cards: [
        {header: 'HOÀN CHO BẠN', icon: '🪙', label: 'Hai đồng', c: 'teal'},
        {header: 'MÓC LẠI', icon: '💸', label: 'Hai chục', c: 'red'},
      ], cardsTop: 450},
    {d: 43, bar: 'red', pose: 'worried', ahCorner: 'left', ahH: 600,
      head: ['Càng hoàn càng ', {t: 'tiêu tợn', c: 'red'}], size: 58},
    {d: 102, bar: 'navy', pose: 'sly', ahCorner: 'right', ahH: 620,
      head: ['Cảm giác LỜI\nchính là mồi'], size: 70,
      icon: '🪝', iconTop: 600, iconSize: 190},
    {d: 142, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Chỉ lời khi đã định mua'], size: 62,
      q: ['Cashback là ', {t: 'lời hay lỗ?', c: 'gold'}]},
  ],
};

export const SHORT_N11: ShortSpec = {
  slug: 'ShortN11',
  scenes: [
    cover('TRẢ TỐI', 'THIỂU', 'LÀ BẪY?', 'Bấm quen = nuôi nợ', 'warning', 37),
    {d: 53, bar: 'amber', pose: 'worried', ahCorner: 'left', ahH: 600,
      head: ['Nợ thẻ'], size: 70,
      value: 50, suffix: ' triệu', staticNum: true, numColor: 'amber', numTop: 540, numSize: 170},
    {d: 86, bar: 'amber', pose: 'sly', ahCorner: 'right', ahH: 600,
      head: ['Bank bảo trả tối thiểu thôi'], size: 56,
      label: ['Chỉ vài % dư nợ'], labelTop: 560, labelC: 'amber'},
    {d: 171, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Phần còn lại bị tính LÃI'], size: 58,
      value: 38, suffix: '%', staticNum: true, numColor: 'red', numTop: 540, numSize: 180,
      label: ['Lãi thẻ 20% – 38%/năm'], labelTop: 850, labelC: 'red'},
    {d: 114, bar: 'navy', pose: 'worried', ahCorner: 'right', ahH: 620,
      head: ['Trả cả năm, ', {t: 'gốc đứng yên', c: 'red'}], size: 60,
      icon: '🔁', iconTop: 600, iconSize: 180},
    {d: 202, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Nút này nuôi nợ, không giảm'], size: 56,
      q: ['Bạn từng ', {t: 'bấm trả tối thiểu', c: 'gold'}, ' chưa?']},
  ],
};

export const SHORT_N12: ShortSpec = {
  slug: 'ShortN12',
  scenes: [
    cover('APP VAY', '5 PHÚT', 'CÓ BẪY?', 'Vay 1 phút, trả cả năm', 'warning', 29),
    {d: 79, bar: 'blue', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Giải ngân trong ', {t: '5 phút', c: 'blue'}], size: 64,
      label: ['Nghe như cứu cánh'], labelTop: 560, labelC: 'blue'},
    {d: 117, bar: 'amber', pose: 'sly', ahCorner: 'right', ahH: 600,
      head: ['App quảng cáo lãi'], size: 58,
      value: 65, suffix: '%', staticNum: true, numColor: 'amber', numTop: 540, numSize: 180,
      label: ['Tầm 35% – 65%/năm'], labelTop: 850, labelC: 'amber'},
    {d: 115, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Cộng đủ phí ẩn, lãi THẬT'], size: 54,
      value: 100, suffix: '%', staticNum: true, numColor: 'red', numTop: 540, numSize: 180,
      label: ['Đội lên 70% – 100%/năm'], labelTop: 850, labelC: 'red'},
    {d: 75, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Vay 5 triệu, ít bữa'], size: 60,
      label: [{t: 'nợ thành gấp rưỡi', c: 'red'}], labelTop: 560, labelC: 'red'},
    {d: 132, bar: 'navy', pose: 'sly', ahCorner: 'left', ahH: 620,
      head: ['Phí tư vấn, phí dịch vụ…'], size: 58,
      icon: '🪝', iconTop: 590, iconSize: 190,
      label: ['Toàn thứ HĐ không nói to'], labelTop: 850, labelC: 'red'},
    {d: 132, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Vay một phút, trả cả năm'], size: 56,
      q: ['Nên ', {t: 'cấm hẳn app vay', c: 'gold'}, ' không?']},
  ],
};

export const SHORT_N13: ShortSpec = {
  slug: 'ShortN13',
  scenes: [
    cover('CAM KẾT', '300%', 'LÀ LỪA?', 'Lãi khủng = cờ đỏ to', 'shock', 93),
    {d: 46, bar: 'red', pose: 'shock', ahCorner: 'left', ahH: 600,
      head: ['Cam kết lãi'], size: 66,
      value: 300, suffix: '%', staticNum: true, numColor: 'red', numTop: 540, numSize: 180},
    {d: 136, bar: 'red', pose: 'warning', ahCorner: 'right', ahH: 620,
      head: ['Đây là ', {t: 'cờ đỏ', c: 'red'}, ' to nhất'], size: 70,
      icon: '🚩', iconTop: 600, iconSize: 190},
    {d: 191, bar: 'navy', pose: 'sly', ahCorner: 'left', ahH: 600,
      head: ['Tiền người sau nuôi người trước'], size: 52,
      cards: [
        {header: 'VÀO TRƯỚC', icon: '🤑', label: 'Rút được thật', c: 'teal'},
        {header: 'VÀO SAU', icon: '💸', label: 'Mất trắng', c: 'red', dim: true},
      ], cardsTop: 450},
    {d: 105, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Tới lượt bạn là ', {t: 'người cuối', c: 'red'}], size: 58,
      label: ['Sập cái là mất trắng'], labelTop: 560, labelC: 'red'},
    {d: 81, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Lãi càng cao càng phải chạy'], size: 54,
      q: ['Ai từng được ', {t: 'mời kiểu này?', c: 'gold'}]},
  ],
};

export const SHORT_N14: ShortSpec = {
  slug: 'ShortN14',
  scenes: [
    cover('VAY TIỀN', 'DÍNH', 'BẢO HIỂM', 'Ô đồng ý tích sẵn', 'facepalm', 54),
    {d: 141, bar: 'amber', pose: 'worried', ahCorner: 'left', ahH: 600,
      head: ['Vay tiền tự nhiên\ndính bảo hiểm'], size: 62,
      label: ['Nhiều người trả mà không biết'], labelTop: 850, labelC: 'amber'},
    {d: 158, bar: 'red', pose: 'sly', ahCorner: 'right', ahH: 600,
      head: ['Gói bảo hiểm khoản vay'], size: 58,
      value: 6, suffix: '%', staticNum: true, numColor: 'red', numTop: 540, numSize: 180,
      label: ['Tầm 3% – 6% khoản vay'], labelTop: 850, labelC: 'red'},
    {d: 144, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Cộng thẳng vào gốc'], size: 66,
      label: [{t: 'Bạn trả LÃI trên cả cục', c: 'red'}], labelTop: 560, labelC: 'red'},
    {d: 35, bar: 'amber', pose: 'warning', ahCorner: 'right', ahH: 600,
      head: ['Ô đồng ý ', {t: 'tích sẵn', c: 'red'}], size: 58,
      icon: '☑️', iconTop: 600, iconSize: 170},
    {d: 111, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Hỏi thẳng: có bắt buộc không?'], size: 52,
      q: ['Bạn có ', {t: 'bị ép mua', c: 'gold'}, ' chưa?']},
  ],
};

export const SHORT_N15: ShortSpec = {
  slug: 'ShortN15',
  scenes: [
    cover('THẺ TÍN', 'DỤNG', 'PHÍ ẨN?', 'Tưởng free mà mất phí', 'sly', 41),
    {d: 119, bar: 'amber', pose: 'sly', ahCorner: 'left', ahH: 600,
      head: ['Xài thẻ tưởng ', {t: 'miễn phí', c: 'teal'}], size: 62,
      label: [{t: 'Nhầm to anh em!', c: 'red'}], labelTop: 560, labelC: 'red'},
    {d: 150, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Phí nằm im khắp nơi'], size: 54,
      cards: [
        {header: 'THƯỜNG NIÊN', icon: '📅', label: 'Năm nào cũng trừ', c: 'red'},
        {header: 'RÚT TIỀN MẶT', icon: '🏧', label: 'Lãi ngay tức thì', c: 'red'},
      ], cardsTop: 450},
    {d: 111, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Phí chuyển đổi trả góp'], size: 58,
      value: 6, suffix: '%', staticNum: true, numColor: 'red', numTop: 540, numSize: 180,
      label: ['Tầm 2,5% – 6%'], labelTop: 850, labelC: 'red'},
    {d: 98, bar: 'navy', pose: 'warning', ahCorner: 'right', ahH: 620,
      head: ['Toàn phí nằm im\ntrong biểu phí'], size: 60,
      icon: '🔍', iconTop: 600, iconSize: 180},
    {d: 133, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Lôi biểu phí ra đọc một lần'], size: 52,
      q: ['Bạn biết thẻ mình ', {t: 'mất phí gì', c: 'gold'}, ' không?']},
  ],
};

export const SHORT_N16: ShortSpec = {
  slug: 'ShortN16',
  scenes: [
    cover('FOMO', 'MUA ĐỈNH', 'LÀ SAO?', 'Cả làng hô = giá cao', 'shock', 57),
    {d: 102, bar: 'amber', pose: 'worried', ahCorner: 'left', ahH: 600,
      head: ['Thấy ai cũng lời\nmình mới nhảy vào'], size: 60,
      label: ['Nghe quen đúng không?'], labelTop: 850, labelC: 'amber'},
    {d: 58, bar: 'red', pose: 'warning', ahCorner: 'right', ahH: 600,
      head: ['Đó là ', {t: 'FOMO', c: 'red'}, ' — sợ bỏ lỡ'], size: 62,
      label: ['Cả làng hô mua = giá đã cao'], labelTop: 560, labelC: 'red'},
    {d: 152, bar: 'red', pose: 'broke', ahCorner: 'left', ahH: 600,
      head: ['Mua đỉnh rồi ', {t: 'bán tháo đáy', c: 'red'}], size: 56,
      icon: '📉', iconTop: 600, iconSize: 190,
      label: ['Mua cao, bán thấp — ngược hết'], labelTop: 850, labelC: 'red'},
    {d: 132, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['Người bình tĩnh\nmua lúc VẮNG người'], size: 58,
      label: [{t: 'Không phải lúc chợ đông', c: 'teal'}], labelTop: 850, labelC: 'teal'},
    {d: 143, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Đám đông là thứ dễ lừa nhất'], size: 54,
      q: ['Bạn từng ', {t: 'mua đỉnh', c: 'gold'}, ' chưa?']},
  ],
};
export const SHORT_N18: ShortSpec = {
  slug: 'ShortN18',
  scenes: [
    cover('VÀNG NỘI', 'CHÊNH 12TR', 'CÒN MUA?', 'Chênh thế giới ~12 triệu', 'shock', 154),
    {d: 113, bar: 'red', pose: 'shock', ahCorner: 'right', ahH: 600,
      head: ['Vàng nội đang chênh'], size: 60,
      value: 12, suffix: ' triệu', staticNum: true, numColor: 'red', numTop: 540, numSize: 190,
      label: ['Cao hơn thế giới mỗi lượng'], labelTop: 850, labelC: 'red'},
    {d: 137, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Nhẫn trơn leo tới'], size: 60,
      value: 142, suffix: ' triệu', staticNum: true, numColor: 'red', numTop: 540, numSize: 160,
      label: ['Mua là lỗ sẵn phần chênh'], labelTop: 850, labelC: 'red'},
    {d: 83, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['Thế giới hạ, trong nước\nvẫn neo cao'], size: 62,
      icon: '⚖️', iconTop: 660, iconSize: 150,
      label: ['Khoảng cách đó ', {t: 'người mua sau gánh', c: 'red'}], labelTop: 880, labelC: 'navy'},
    {d: 199, bar: 'navy', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Vàng vẫn là chỗ thủ\nnhưng ', {t: 'chênh dày cỡ này', c: 'red'}], size: 60,
      icon: '⚠️', iconTop: 620, iconSize: 160,
      label: ['Xuống tiền lúc này là can đảm'], labelTop: 880, labelC: 'red'},
    {d: 101, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Chênh vậy bạn\ncòn xuống tiền?'], size: 66,
      cards: [
        {header: 'ĐỀU TAY', icon: '💰', label: 'Thủ dài, kệ chênh', c: 'teal'},
        {header: 'ĐỨNG NGOÀI', icon: '⏳', label: 'Chờ hạ nhiệt', c: 'blue'},
      ], cardsTop: 450},
  ],
};

export const SHORT_N19: ShortSpec = {
  slug: 'ShortN19',
  scenes: [
    cover('CHẶN', '5.200 TỶ', 'LỪA ĐẢO', 'Tài khoản bạn bị soi?', 'warning', 83),
    {d: 129, bar: 'red', pose: 'shock', ahCorner: 'right', ahH: 600,
      head: ['Hệ thống vừa chặn ', {t: '5.200 tỷ', c: 'red'}, '\ngiao dịch nghi lừa đảo'], size: 58,
      icon: '🚫', iconTop: 640, iconSize: 160,
      label: ['Con số nghe giật mình đúng không'], labelTop: 900, labelC: 'red'},
    {d: 173, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['100 – 150 nghìn tài khoản\nbị ', {t: 'gắn cờ', c: 'red'}], size: 58,
      icon: '🚩', iconTop: 640, iconSize: 160,
      label: ['Tiền ra vào bất thường là dính'], labelTop: 900, labelC: 'navy'},
    {d: 230, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['Đa phần chặn nhầm\ncòn hơn bỏ sót'], size: 62,
      icon: '🔒', iconTop: 620, iconSize: 150,
      label: ['Nhưng ', {t: 'phiền thì có phiền', c: 'red'}], labelTop: 880, labelC: 'navy'},
    {d: 64, bar: 'red', pose: 'warning', ahCorner: 'right', ahH: 600,
      head: ['Đừng cho mượn\ntài khoản!'], size: 68,
      icon: '🚫', iconTop: 660, iconSize: 160},
    {d: 126, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Bạn từng bị khóa\ngiao dịch chưa?'], size: 66,
      cards: [
        {header: 'ĐÃ TỪNG', icon: '😵', label: 'Bị chặn oan', c: 'red'},
        {header: 'CHƯA HỀ', icon: '😎', label: 'Vẫn suôn sẻ', c: 'teal'},
      ], cardsTop: 450},
  ],
};

export const SHORT_N20: ShortSpec = {
  slug: 'ShortN20',
  scenes: [
    cover('QUÉT MẶT', 'TIỀN VẪN', 'BỐC HƠI', 'Chiêu "chạm ma" là gì?', 'shock', 49),
    {d: 87, bar: 'red', pose: 'shock', ahCorner: 'right', ahH: 600,
      head: ['Xác thực khuôn mặt xong\ntiền vẫn bay'], size: 60,
      icon: '👻', iconTop: 640, iconSize: 170,
      label: ['Chiêu này gọi là "chạm ma"'], labelTop: 900, labelC: 'red'},
    {d: 92, bar: 'navy', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Bạn tải một app lạ\nnó xin quyền Trợ năng'], size: 60,
      icon: '📲', iconTop: 640, iconSize: 160,
      label: ['Bấm đồng ý cho nhanh là xong'], labelTop: 900, labelC: 'navy'},
    {d: 164, bar: 'red', pose: 'warning', ahCorner: 'right', ahH: 600,
      head: ['App âm thầm\nđiều khiển máy'], size: 64,
      icon: '🕹️', iconTop: 640, iconSize: 170,
      label: ['Dựng sẵn hàng loạt lệnh chuyển'], labelTop: 900, labelC: 'red'},
    {d: 164, bar: 'red', pose: 'broke', ahCorner: 'right', ahH: 600,
      head: ['Quét sinh trắc một lần\nnó chạy ngầm cả loạt'], size: 58,
      icon: '💸', iconTop: 640, iconSize: 170,
      label: ['Mặt bạn thật, ', {t: 'lệnh cũng qua', c: 'red'}], labelTop: 900, labelC: 'red'},
    {d: 164, bar: 'navy', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['Vấn đề không ở mặt\nnằm ở ', {t: 'quyền bạn lỡ bật', c: 'red'}], size: 58,
      icon: '⚠️', iconTop: 640, iconSize: 160,
      label: ['App lạ xin Trợ năng là báo động'], labelTop: 900, labelC: 'navy'},
    {d: 100, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Bạn có bật Trợ năng\ncho app lạ không?'], size: 62,
      cards: [
        {header: 'CÓ TỪNG', icon: '😰', label: 'Bấm cho nhanh', c: 'red'},
        {header: 'CẢNH GIÁC', icon: '🛡️', label: 'Không bật bừa', c: 'teal'},
      ], cardsTop: 450},
  ],
};

export const SHORT_N21: ShortSpec = {
  slug: 'ShortN21',
  scenes: [
    cover('THUẾ SOI', 'TÀI KHOẢN', 'CÁ NHÂN', 'Freelancer vào tầm ngắm', 'worried', 139),
    {d: 121, bar: 'red', pose: 'shock', ahCorner: 'right', ahH: 600,
      head: ['Thuế đang soi dòng tiền\ntài khoản cá nhân'], size: 58,
      icon: '🔍', iconTop: 640, iconSize: 160,
      label: ['Tiền cá nhân giờ cũng bị soi'], labelTop: 900, labelC: 'red'},
    {d: 62, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Freelancer nhận job\ncũng trong tầm ngắm'], size: 60,
      icon: '🎯', iconTop: 660, iconSize: 160},
    {d: 124, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['Tiền về đều, ghi rõ\ndịch vụ = dấu hiệu'], size: 60,
      icon: '💵', iconTop: 640, iconSize: 160,
      label: ['Có thu nhập là ', {t: 'có nghĩa vụ thuế', c: 'red'}], labelTop: 900, labelC: 'navy'},
    {d: 124, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Không phải nhận tiền\nlà bị truy ngay'], size: 60,
      icon: '⚖️', iconTop: 640, iconSize: 150,
      label: ['Dòng tiền lớn thì nên minh bạch'], labelTop: 900, labelC: 'navy'},
    {d: 159, bar: 'teal', pose: 'present', ahCorner: 'right', ahH: 600,
      head: ['Ghi chép cho gọn\nchủ động vẫn hơn'], size: 62,
      icon: '🗂️', iconTop: 640, iconSize: 160,
      label: ['Đừng để bị hỏi mới cuống'], labelTop: 900, labelC: 'teal'},
    {d: 86, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Freelancer\ncó nên lo không?'], size: 66,
      cards: [
        {header: 'NÊN LO', icon: '⚠️', label: 'Dòng tiền lớn', c: 'amber'},
        {header: 'BÌNH TĨNH', icon: '🗂️', label: 'Đã minh bạch', c: 'teal'},
      ], cardsTop: 450},
  ],
};

export const SHORT_N22: ShortSpec = {
  slug: 'ShortN22',
  scenes: [
    cover('SA THẢI', 'VÌ AI', 'NGHỀ NÀO?', 'Việc của bạn có an toàn?', 'worried', 41),
    {d: 81, bar: 'red', pose: 'shock', ahCorner: 'right', ahH: 600,
      head: ['Có nơi cắt cả ngàn người\nlý do: ', {t: 'AI', c: 'red'}], size: 58,
      icon: '🤖', iconTop: 640, iconSize: 170,
      label: ['Nghe lạnh gáy đúng không'], labelTop: 900, labelC: 'red'},
    {d: 112, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Việc lặp đi lặp lại\nlà dễ bị thay'], size: 62,
      icon: '🔁', iconTop: 640, iconSize: 160,
      label: ['Máy làm nhanh hơn, rẻ hơn'], labelTop: 900, labelC: 'red'},
    {d: 160, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['Nhập liệu, tổng hợp\ntrả lời mẫu — AI nuốt gọn'], size: 56,
      icon: '📥', iconTop: 640, iconSize: 150,
      label: ['Nhưng khoan bi quan'], labelTop: 900, labelC: 'navy'},
    {d: 100, bar: 'teal', pose: 'aha', ahCorner: 'right', ahH: 600,
      head: ['AI giỏi việc lặp\nkém việc phán đoán'], size: 62,
      icon: '🧠', iconTop: 640, iconSize: 160,
      label: ['Việc cần hiểu người thì khó thay'], labelTop: 900, labelC: 'teal'},
    {d: 145, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['Ai biết dùng AI\nlàm trợ lý lại lợi'], size: 62,
      icon: '🚀', iconTop: 640, iconSize: 160,
      label: ['Ai đứng im mới đáng lo'], labelTop: 900, labelC: 'teal'},
    {d: 86, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Nghề bạn AI\nthay được không?'], size: 66,
      cards: [
        {header: 'DỄ THAY', icon: '🤖', label: 'Việc lặp lại', c: 'red'},
        {header: 'KHÓ THAY', icon: '🧠', label: 'Cần phán đoán', c: 'teal'},
      ], cardsTop: 450},
  ],
};
export const SHORT_N24: ShortSpec = {
  slug: 'ShortN24',
  scenes: [
    cover('LẠM PHÁT', 'ĂN TIỀN', 'MỖI NĂM', 'Đứng yên là đi lùi', 'shock', 79),
    {d: 33, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Không mất tờ nào'], size: 66,
      label: ['Nhưng vẫn ', {t: 'nghèo đi', c: 'red'}], labelTop: 560, labelC: 'red'},
    {d: 31, bar: 'red', pose: 'shock', ahCorner: 'left', ahH: 600,
      head: ['Đó là ', {t: 'LẠM PHÁT', c: 'red'}], size: 72},
    {d: 56, bar: 'red', pose: 'broke', ahCorner: 'right', ahH: 600,
      head: ['Tiền bị ', {t: 'teo nhỏ', c: 'red'}], size: 66,
      icon: '💸', iconTop: 540, iconSize: 160},
    {d: 359, bar: 'blue', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Mỗi năm bốc hơi ', {t: '3–4%', c: 'red'}], size: 60,
      icon: '🍜', iconTop: 540, iconSize: 170,
      label: ['Tiền y nguyên, mua được ít hơn'], labelTop: 850, labelC: 'navy'},
    {d: 30, bar: 'red', pose: 'broke', ahCorner: 'right', ahH: 600,
      head: ['Không kỳ hạn ', {t: '0,1–0,5%', c: 'gray'}], size: 58,
      label: [{t: 'Coi như lỗ', c: 'red'}], labelTop: 560, labelC: 'red'},
    {d: 179, bar: 'teal', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Gửi tiết kiệm để ', {t: 'chạy đua kịp', c: 'teal'}], size: 54,
      cards: [
        {header: 'KHÔNG KỲ HẠN', icon: '🐌', label: '0,1–0,5%', c: 'gray', dim: true},
        {header: 'TIẾT KIỆM', icon: '🏃', label: '4,7–6%', c: 'teal'},
      ], cardsTop: 450},
    {d: 120, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Đứng yên là ', {t: 'tự thua', c: 'red'}], size: 62,
      q: ['Bạn ', {t: 'để tiền ở đâu', c: 'gold'}, '\nchống lạm phát?']},
  ],
};

export const SHORT_N25: ShortSpec = {
  slug: 'ShortN25',
  scenes: [
    cover('QUỸ', 'KHẨN CẤP', 'BAO NHIÊU?', 'Tiền cứu mạng lúc ngặt', 'think', 69),
    {d: 274, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Mất việc đột ngột —\nsống được ', {t: 'mấy tháng?', c: 'red'}], size: 60,
      icon: '😰', iconTop: 540, iconSize: 160,
      label: ['Tiền cứu mạng lúc ngặt, không phải để đầu tư'], labelTop: 850, labelC: 'navy'},
    {d: 60, bar: 'blue', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['Bao nhiêu là ', {t: 'đủ', c: 'blue'}, '?'], size: 74},
    {d: 32, bar: 'blue', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Bằng ', {t: '3–6 tháng', c: 'blue'}, ' chi phí'], size: 58},
    {d: 46, bar: 'amber', pose: 'warning', ahCorner: 'left', ahH: 600,
      head: ['Thu nhập bấp bênh?'], size: 58,
      label: [{t: 'Để dư hơn', c: 'amber'}], labelTop: 560, labelC: 'amber'},
    {d: 41, bar: 'red', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Đừng chôn ', {t: 'BĐS', c: 'red'}, ',\nđừng dồn ', {t: 'cổ phiếu', c: 'red'}], size: 56},
    {d: 32, bar: 'teal', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['Cần là ', {t: 'có ngay', c: 'teal'}], size: 66},
    {d: 323, bar: 'teal', pose: 'cool', ahCorner: 'right', ahH: 680,
      head: ['Để ', {t: 'tiết kiệm dễ rút', c: 'teal'}, ', lãi ', {t: '4–6%', c: 'teal'}], size: 56,
      label: ['Vừa an toàn vừa lấy được liền — ngủ ngon hẳn'], labelTop: 560, labelC: 'teal',
      q: ['Bạn có quỹ ', {t: 'mấy tháng', c: 'gold'}, ' chi phí?']},
  ],
};

export const SHORT_N26: ShortSpec = {
  slug: 'ShortN26',
  scenes: [
    cover('DÀNH TRƯỚC', 'HAY SAU', 'ĐỔI GIA TÀI', 'Chỉ đổi thứ tự', 'aha', 41),
    {d: 161, bar: 'blue', pose: 'think', ahCorner: 'right', ahH: 600,
      head: ['2 người ', {t: 'lương y hệt', c: 'navy'}, '\n20 năm sau ', {t: 'khác hẳn', c: 'red'}], size: 58,
      label: ['Khác mỗi... ', {t: 'thứ tự', c: 'gold'}], labelTop: 850, labelC: 'navy'},
    {d: 248, bar: 'navy', pose: 'present', ahCorner: 'left', ahH: 600,
      head: ['Cùng lương, khác ', {t: 'thứ tự', c: 'gold'}], size: 54,
      cards: [
        {header: 'TIÊU TRƯỚC', icon: '🛒', label: 'Dư mới để dành → hết', c: 'red', dim: true},
        {header: 'DÀNH TRƯỚC', icon: '🏦', label: 'Còn lại mới tiêu → luôn có', c: 'teal'},
      ], cardsTop: 450},
    {d: 31, bar: 'blue', pose: 'shrug', ahCorner: 'right', ahH: 600,
      head: ['Cùng lương, cùng thời gian'], size: 54},
    {d: 112, bar: 'navy', pose: 'warning', ahCorner: 'left', ahH: 600,
      head: ['Một người ', {t: 'có của', c: 'teal'}, '\nmột người ', {t: 'tay trắng', c: 'red'}], size: 58,
      label: ['Cùng xuất phát, khác kết cục'], labelTop: 850, labelC: 'navy'},
    {d: 44, bar: 'teal', pose: 'point', ahCorner: 'right', ahH: 600,
      head: ['Lương về, ', {t: 'trích ngay', c: 'teal'}], size: 62},
    {d: 135, bar: 'amber', pose: 'warning', ahCorner: 'left', ahH: 600,
      head: ['Coi như khoản ', {t: 'bắt buộc', c: 'gold'}], size: 58,
      icon: '📌', iconTop: 540, iconSize: 150,
      label: ['Chờ dư mới dành: chẳng bao giờ dư'], labelTop: 850, labelC: 'red'},
    {d: 114, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 680,
      head: ['Cứ ', {t: 'trích trước', c: 'teal'}, ' đã'], size: 64,
      q: ['Bạn để dành ', {t: 'đầu tháng', c: 'teal'}, '\nhay ', {t: 'cuối tháng', c: 'gray'}, '?']},
  ],
};
export const SHORT_N28: ShortSpec = {
  slug: 'ShortN28',
  scenes: [
    cover('AI CƯỚP', 'VIỆC?', '3 THỨ TRỤ', 'Máy khó đụng nổi', 'point', 45),
    {d: 180, bar: 'navy', pose: 'worried', ahCorner: 'right', ahH: 600,
      head: ['Lo AI cướp việc?'], size: 72,
      label: ['Ba thứ này nó ', {t: 'KHÓ ĐỤNG', c: 'teal'}], labelTop: 560, labelC: 'navy'},
    {d: 160, bar: 'teal', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['MỘT: Hiểu người'], size: 68,
      icon: '🤝', iconTop: 540, iconSize: 180,
      label: ['AI đọc lòng người rất kém'], labelTop: 850, labelC: 'teal'},
    {d: 140, bar: 'blue', pose: 'cool', ahCorner: 'right', ahH: 600,
      head: ['HAI: Đôi tay'], size: 68,
      icon: '🛠️', iconTop: 540, iconSize: 180,
      label: ['Thợ điện, đầu bếp — máy khó thay'], labelTop: 850, labelC: 'blue'},
    {d: 150, bar: 'amber', pose: 'think', ahCorner: 'left', ahH: 600,
      head: ['BA: Ra quyết định'], size: 62,
      icon: '🧭', iconTop: 540, iconSize: 180,
      label: ['AI không dám chịu trách nhiệm'], labelTop: 850, labelC: 'amber'},
    {d: 150, bar: 'navy', pose: 'sly', ahCorner: 'right', ahH: 600,
      head: ['Càng làm càng lên tay'], size: 62,
      label: ['Đừng thi ', {t: 'cái AI giỏi', c: 'gold'}], labelTop: 560, labelC: 'navy'},
    {d: 98, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Chơi phần nó dở ấy'], size: 74,
      q: ['Bạn đang có ', {t: 'kỹ năng nào?', c: 'gold'}]},
  ],
};

export const SHORT_N29: ShortSpec = {
  slug: 'ShortN29',
  scenes: [
    cover('LƯƠNG CAO', 'CHƯA', 'AN TOÀN', 'Nghề nào AI khó thay', 'sly', 49),
    {d: 140, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 600,
      head: ['Nghề bị chê lại khó thay'], size: 60,
      label: ['Nghe lạ mà ', {t: 'thật đó', c: 'teal'}], labelTop: 560, labelC: 'navy'},
    {d: 210, bar: 'navy', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['AI nuốt việc lặp lại'], size: 62,
      cards: [
        {header: 'BÀN GIẤY', icon: '📄', label: 'AI nuốt', c: 'gray', dim: true},
        {header: 'TAY CHÂN', icon: '🔧', label: 'Khó thay', c: 'teal'},
      ], cardsTop: 450},
    {d: 150, bar: 'teal', pose: 'present', ahCorner: 'right', ahH: 600,
      head: ['Nghề chăm người'], size: 68,
      icon: '🩺', iconTop: 540, iconSize: 180,
      label: ['Cần hơi ấm con người'], labelTop: 850, labelC: 'teal'},
    {d: 130, bar: 'blue', pose: 'aha', ahCorner: 'left', ahH: 600,
      head: ['Sáng tạo gốc, chịu trách nhiệm'], size: 54,
      icon: '🎨', iconTop: 540, iconSize: 170,
      label: ['Loại nghề này trụ lâu'], labelTop: 850, labelC: 'blue'},
    {d: 120, bar: 'navy', pose: 'smug', ahCorner: 'right', ahH: 600,
      head: ['Chân tay không hề thấp'], size: 60,
      label: ['Giờ nó lại ', {t: 'chắc hơn', c: 'gold'}], labelTop: 560, labelC: 'navy'},
    {d: 105, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Cứ khó máy là trụ'], size: 74,
      q: ['Nghề bạn ', {t: 'nằm ở đâu?', c: 'gold'}]},
  ],
};

export const SHORT_N30: ShortSpec = {
  slug: 'ShortN30',
  scenes: [
    cover('VIẾT CV', 'BẰNG AI', 'ĐÚNG CÁCH', 'Để được gọi lại', 'point', 52),
    {d: 150, bar: 'navy', pose: 'think', ahCorner: 'right', ahH: 600,
      head: ['Cùng viết CV bằng AI'], size: 62,
      label: ['Người bị loại, người ', {t: 'được gọi', c: 'teal'}], labelTop: 560, labelC: 'navy'},
    {d: 210, bar: 'navy', pose: 'point', ahCorner: 'left', ahH: 600,
      head: ['Khác đúng một chỗ'], size: 64,
      cards: [
        {header: 'CHUNG CHUNG', icon: '📋', label: 'Bị loại', c: 'gray', dim: true},
        {header: 'THÀNH TÍCH THẬT', icon: '🎯', label: 'Được gọi', c: 'teal'},
      ], cardsTop: 450},
    {d: 150, bar: 'teal', pose: 'present', ahCorner: 'right', ahH: 600,
      head: ['Cách người được gọi'], size: 60,
      icon: '📝', iconTop: 540, iconSize: 175,
      label: ['Bảo AI viết khớp tin tuyển dụng'], labelTop: 850, labelC: 'teal'},
    {d: 120, bar: 'blue', pose: 'sly', ahCorner: 'left', ahH: 600,
      head: ['AI không đẻ thành tích hộ'], size: 56,
      label: ['Nó chỉ xếp ', {t: 'gọn và trúng', c: 'blue'}], labelTop: 560, labelC: 'navy'},
    {d: 100, bar: 'red', pose: 'warning', ahCorner: 'right', ahH: 600,
      head: ['Rác vào thì rác ra'], size: 64,
      label: [{t: 'Đồ thật', c: 'gold'}, ' mới ăn tiền'], labelTop: 560, labelC: 'navy'},
    {d: 107, bar: 'navy', pose: 'think', ahCorner: 'left', ahH: 680,
      head: ['Thử ngay hôm nay'], size: 74,
      q: ['Bạn đã ', {t: 'thử chưa?', c: 'gold'}]},
  ],
};
