...
export const SHORT_OMDAT: ShortSpec = {
  ...
  scenes: [
    ...
    {d: 117, bar: 'red', pose: 'broke', ahH: 600,
      ...
      value: 13, suffix: ' triệu', numColor: 'red', numTop: 540, numSize: 190,
    ...
    {d: 81, bar: 'red', pose: 'shock', ahH: 600,
      ...
      value: 30, suffix: '%', numColor: 'red', numTop: 540, numSize: 190,
    ...
    {d: 150, bar: 'teal', pose: 'cool', ahCorner: 'left', ahH: 600,
      ...
      value: 90, suffix: ' tr/năm', numColor: 'teal', numTop: 540, numSize: 180,
