...
// ===== TUYẾN A — 6 short bóc từ 7 Bẫy (d TẠM — neo lại theo silence khi có Vbee) =====
export const SHORT_A1: ShortSpec = { slug: 'ShortA1', scenes: [
  cover('LƯƠNG VỀ', 'LÀ HẾT', 'VÌ SAO?', 'Bẫy tiền số 1', 'worried', 152),
  {d: 243, ahSmall: true, bar: 'red', pose: 'facepalm', ahCorner: 'right',
    head: ['Lương về ', {t: 'tiêu trước', c: 'red'}, ', cuối tháng cạn'], size: 76,
    icon: '💸😵', iconTop: 540, iconSize: 150},
  {d: 231, ahSmall: true, bar: 'navy', pose: 'explain', ahCorner: 'left', ahH: 600,
    head: ['Y như đi ', {t: 'buffet', c: 'navy'}], size: 82,
    cards: [
      {header: 'NGƯỜI KHÔN', icon: '🦐', label: 'Gắp món chính trước', c: 'teal'},
      {header: 'NGƯỜI NON', icon: '🍟', label: 'No món vặt, tiếc', c: 'red', dim: true},
    ], cardsTop: 440},
  {d: 164, ahSmall: true, bar: 'teal', pose: 'present', ahCorner: 'right',
    head: ['Lương về là ', {t: 'TRÍCH cất trước', c: 'teal'}], size: 78,
    label: ['Còn lại mới đem tiêu'], labelTop: 800, labelC: 'teal'},
  {d: 188, ahSmall: true, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 700,
    head: ['Còn bạn?'], size: 96, icon: '🤔', iconTop: 520, iconSize: 150,
    q: ['Bạn đang ', {t: 'trích trước hay tiêu trước?', c: 'gold'}]},
]};
export const SHORT_A2: ShortSpec = { slug: 'ShortA2', scenes: [
  cover('LƯƠNG', 'GẤP ĐÔI', 'VẪN NGHÈO', 'Lạm phát lối sống', 'worried', 171),
  {d: 286, ahSmall: true, bar: 'blue', pose: 'worried', ahCorner: 'right',
    head: ['7–8tr → ', {t: '15tr', c: 'blue'}, ', vẫn trắng tay'], size: 76,
    icon: '📈😩', iconTop: 540, iconSize: 150},
  {d: 249, ahSmall: true, bar: 'navy', pose: 'explain', ahCorner: 'left', ahH: 600,
    head: ['Cái ', {t: 'áo rộng', c: 'red'}, ' theo người'], size: 82,
    icon: '👕📈', iconTop: 520, iconSize: 170,
    label: ['Lương lên tới đâu, lối sống phình tới đó'], labelTop: 820, labelC: 'navy'},
  {d: 210, ahSmall: true, bar: 'teal', pose: 'present', ahCorner: 'right',
    head: ['Lương lên ', {t: '10 phần', c: 'teal'}], size: 82,
    label: ['Lối sống lên vài phần, còn lại giữ làm của'], labelTop: 800, labelC: 'teal'},
  {d: 120, ahSmall: true, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 700,
    head: ['Thành thật nhé…'], size: 82,
    q: ['Lương tăng, ', {t: 'tiền để dành có tăng?', c: 'gold'}]},
]};
export const SHORT_A3: ShortSpec = { slug: 'ShortA3', scenes: [
  cover('TRẢ GÓP', '0% LÃI', 'CÓ THẬT?', 'Miễn phí = cái bẫy', 'sly', 190),
  {d: 199, ahSmall: true, bar: 'amber', pose: 'sly', ahCorner: 'right',
    head: ['Miễn phí thật thì ', {t: 'bán cho ai ăn?', c: 'red'}], size: 74,
    icon: '🧀', iconTop: 540, iconSize: 170},
  {d: 260, ahSmall: true, bar: 'navy', pose: 'warning', ahCorner: 'left', ahH: 600,
    head: ['Phô mai miễn phí nằm trong…'], size: 74,
    icon: '🧀🪤', iconTop: 520, iconSize: 180,
    label: [{t: 'CÁI BẪY CHUỘT', c: 'red'}], labelTop: 820, labelC: 'red'},
  {d: 275, ahSmall: true, bar: 'blue', pose: 'explain', ahCorner: 'right',
    head: ['0% chỉ ', {t: 'đổi tên', c: 'blue'}], size: 82,
    label: ['Phí chuyển đổi + bảo hiểm khoản vay'], labelTop: 800, labelC: 'blue'},
  {d: 223, ahSmall: true, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 700,
    head: ['Trước khi ký, hỏi:'], size: 72,
    q: ['Bắt trả hết 1 lần — ', {t: 'mình có mua không?', c: 'gold'}]},
]};
export const SHORT_A4: ShortSpec = { slug: 'ShortA4', scenes: [
  cover('ĐỂ DÀNH', 'VẪN NGHÈO', 'VÌ SAO?', 'Giữ tiền sai chỗ', 'worried', 181),
  {d: 192, ahSmall: true, bar: 'red', pose: 'facepalm', ahCorner: 'right',
    head: ['Không kỳ hạn: lãi ', {t: '~0%', c: 'red'}, '/năm'], size: 74,
    icon: '🏦😐', iconTop: 540, iconSize: 150},
  {d: 311, ahSmall: true, bar: 'navy', pose: 'warning', ahCorner: 'left', ahH: 600,
    head: ['Như ', {t: 'cục đá', c: 'blue'}, ' để ngoài nắng'], size: 80,
    icon: '🧊☀️', iconTop: 520, iconSize: 180,
    label: ['Teo dần, còn mỗi vũng nước'], labelTop: 820, labelC: 'navy'},
  {d: 268, ahSmall: true, bar: 'teal', pose: 'present', ahCorner: 'right',
    head: ['Để đúng chỗ ', {t: 'chạy kịp lạm phát', c: 'teal'}], size: 70,
    label: ['Gửi kỳ hạn 4,7–6%/năm'], labelTop: 800, labelC: 'teal'},
  {d: 148, ahSmall: true, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 700,
    head: ['Còn bạn?'], size: 96, icon: '🤔', iconTop: 520, iconSize: 150,
    q: ['Bạn để tiền nhàn rỗi ', {t: 'ở đâu?', c: 'gold'}]},
]};
export const SHORT_A5: ShortSpec = { slug: 'ShortA5', scenes: [
  cover('AI CŨNG', 'MUA ĐI', 'RỒI SAO?', 'Đầu tư phong trào', 'shock', 185),
  {d: 314, ahSmall: true, bar: 'amber', pose: 'greedy', ahCorner: 'right',
    head: ['Ai cũng hô ', {t: 'mua đi, trễ là hết', c: 'red'}], size: 72,
    icon: '📢🏃', iconTop: 540, iconSize: 160},
  {d: 323, ahSmall: true, bar: 'navy', pose: 'warning', ahCorner: 'left', ahH: 600,
    head: ['Cả làng chạy ', {t: 'một hướng', c: 'red'}], size: 80,
    icon: '🏃🏃🏃', iconTop: 520, iconSize: 170,
    label: ['Vào sau = chỗ đắt nhất, ôm lỗ'], labelTop: 820, labelC: 'red'},
  {d: 167, ahSmall: true, bar: 'teal', pose: 'explain', ahCorner: 'right',
    head: ['Đầu tư vì mình ', {t: 'HIỂU', c: 'teal'}], size: 82,
    label: ['Không phải vì người ta HÔ'], labelTop: 800, labelC: 'teal'},
  {d: 141, ahSmall: true, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 700,
    head: ['Thú thật nhé…'], size: 82,
    q: ['Bạn từng ', {t: 'FOMO mua đỉnh mất tiền?', c: 'gold'}]},
]};
export const SHORT_A6: ShortSpec = { slug: 'ShortA6', scenes: [
  cover('3TR/THÁNG', '= 1,5 TỶ', 'CÁCH NÀO?', 'Sức mạnh lãi kép', 'greedy', 189),
  {d: 224, ahSmall: true, bar: 'gold', pose: 'explain', ahCorner: 'right',
    head: ['3tr/tháng, đều ', {t: '20 năm', c: 'blue'}], size: 80,
    icon: '☕📅', iconTop: 540, iconSize: 150},
  {d: 299, ahSmall: true, bar: 'gold', pose: 'greedy', ahCorner: 'right', ahH: 600,
    head: ['Được khoảng ', {t: '1,5 tỷ', c: 'gold'}], size: 92,
    label: ['Gốc mình bỏ chỉ ~720tr'], labelTop: 800, labelC: 'navy'},
  {d: 233, ahSmall: true, bar: 'teal', pose: 'aha', ahCorner: 'left',
    head: ['Tiền tự đẻ tiền = ', {t: 'quả cầu tuyết', c: 'teal'}], size: 66,
    icon: '⛄', iconTop: 540, iconSize: 170,
    label: ['Càng lăn càng to'], labelTop: 800, labelC: 'teal'},
  {d: 183, ahSmall: true, bar: 'navy', pose: 'point', ahCorner: 'right', ahH: 700,
    head: ['Bắt đầu sớm là ăn!'], size: 80,
    q: ['Bạn để dành ', {t: 'mỗi tháng bao nhiêu?', c: 'gold'}]},
]};

export const ALL_SHORTS: ShortSpec[] = [SHORT_A1, SHORT_A2, SHORT_A3, SHORT_A4, SHORT_A5, SHORT_A6, SHORT_THEMTIEN, SHORT_DNRUT, SHORT_SODO, SHORT_N01, SHORT_N02, SHORT_N03, SHORT_N04, SHORT_N05, SHORT_N06, SHORT_N07, SHORT_N08, SHORT_N09, SHORT_N10, SHORT_N11, SHORT_N12, SHORT_N13, SHORT_N14, SHORT_N15, SHORT_N16, SHORT_N17, SHORT_N18, SHORT_N19, SHORT_N20, SHORT_N21, SHORT_N22, SHORT_N23, SHORT_N24, SHORT_N25, SHORT_N26, SHORT_N27, SHORT_N28, SHORT_N29, SHORT_N30, SHORT_DT1, SHORT_DT2, SHORT_DT3, SHORT_DT4, SHORT_DT5, SHORT_COVER, SHORT_G01, SHORT_G02, SHORT_G03, SHORT_G04, SHORT_G05, SHORT_E01, SHORT_E02, SHORT_E03, SHORT_E04, SHORT_E05, SHORT_E06, SHORT_E07, SHORT_E08, SHORT_E09, SHORT_E10, SHORT_MRPIPS, SHORT_D01, SHORT_D02, SHORT_D03, SHORT_D04, SHORT_D05, SHORT_D06, SHORT_D07, SHORT_D08, SHORT_D09, SHORT_D10, SHORT_SR1, SHORT_TT01, SHORT_TT02, SHORT_TT03, SHORT_TT04, SHORT_TT05, SHORT_TT06, SHORT_TT07, SHORT_TT08, SHORT_TT09, SHORT_TT10, SHORT_PNJ, SHORT_LONGTHANH936, SHORT_KIMCUONG_GIA, SHORT_THUEDAT_P2, SHORT_THUEDAT, SHORT_LIENNH, SHORT_TAIKHOAN, SHORT_BAYPHI, SHORT_VANG2, SHORT_LAISUAT_A, SHORT_LAISUAT_B, SHORT_SJC, SHORT_ANHTUAN, SHORT_OMDAT, SHORT_PRODEMO, SHORT_DATDAI_PRO, SHORT_LK1, SHORT_KIMCUONG, SHORT_VANG, SHORT_RE13, SHORT_BDS_S1, SHORT_BDS_S2, SHORT_BDS_S4, SHORT_TK80, SHORT_DIEMTIN, SHORT_DIEMTIN23, SHORT_SS01, SHORT_SS02, SHORT_SS03, SHORT_SS04, SHORT_SS05, SHORT_SS06, SHORT_SS07, SHORT_SS08, SHORT_SS09, SHORT_SS10, SHORT_SS11, SHORT_SS12, SHORT_SS13, SHORT_SS14, SHORT_SS15, SHORT_SS16, SHORT_SS17, SHORT_SS18, SHORT_SS19, SHORT_SS20, SHORT_SS21, SHORT_SS22, SHORT_SS23, SHORT_SS24, SHORT_SS25, SHORT_SS26, SHORT_SS27, SHORT_SS28, SHORT_SS29, SHORT_SS30, SHORT_DATDAI];
