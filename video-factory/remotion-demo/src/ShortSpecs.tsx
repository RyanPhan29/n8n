...
export const SHORT_ANHTUAN: ShortSpec = {
  ...
  scenes: [
    ...
    {d: 169, bar: 'red', pose: 'broke', ahH: 600,
      head: ['Gộp lại, mỗi ngày mất hơn'], size: 60,
      value: 1, suffix: ' TRIỆU', staticNum: true, numColor: 'red', numTop: 540, numSize: 200,
      label: ['Kể cả ngày anh nằm ngủ, tiền vẫn chảy'], labelTop: 850, labelC: 'red'},
