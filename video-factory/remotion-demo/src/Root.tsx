...
import {DonBaySim, DONBAY_DURATION} from './DonBaySim';
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      <Composition id="DonBaySim" component={DonBaySim} durationInFrames={DONBAY_DURATION} fps={30} width={1920} height={1080} />
