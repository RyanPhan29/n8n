...
(function () {
  ...
  var DICT = {
    ...
    'hero.tagline': {
      vi: '10 năm kinh nghiệm · 5000+ lượt khách đã đồng hành điều trị. Không phải spa. Không quảng cáo ảo. Chỉ có phác đồ y khoa được cá nhân hoá cho từng khách.',
      en: '10 years of experience · 5,000+ patients accompanied through treatment. Not a spa. No empty promises — only personalized medical treatment plans for each patient.',
      ko: '10년 경력 · 5,000명 이상 치료 동행. 스파가 아닙니다. 과장 광고 없이, 환자 개개인에 맞춘 의료 치료 프로토콜만 제공합니다.',
      zh: '10年经验 · 陪伴 5000+ 顾客治疗。不是美容院，没有虚假宣传——只有为每位顾客量身定制的医学治疗方案。', ja: '経験10年 · 5,000名以上の治療サポート実績。エステではありません。誇大広告なし——一人ひとりに合わせた医療プロトコルのみを提供します。' },
    ...
    'ab.b3':      { vi: '5000+ khách điều trị', en: '5,000+ patients treated', ko: '5,000명+ 치료', zh: '5000+ 治疗顾客', ja: '5,000名以上の治療サポート実績' },
    ...
    'ft.copy': { vi: '© 2026 Phòng khám Da liễu BS CKI Lê Hiếu — SKINLAB DE BEAUTY. Bảo lưu mọi quyền.', en: '© 2026 Dr. Le Hieu Dermatology Clinic — SKINLAB DE BEAUTY. All rights reserved.', ko: '© 2026 Le Hieu 피부과 클리닉 — SKINLAB DE BEAUTY. 모든 권리 보유.', zh: '© 2026 Lê Hiếu 皮肤科诊所 — SKINLAB DE BEAUTY. 版权所有。', ja: '© 2026 レ・ヒエウ皮膚科クリニック — SKINLAB DE BEAUTY. 無断転載禁止。' },
